#!/usr/bin/env python3
"""One-off: re-capture iPhone 11 (6.5") en-US to verify Settings sheet
shows up after -OpenSettings relaunch refactor."""
...
def main():
    ...
    def _filtered(self, lid):
        device = ScreenshotSource(device=device_name, size="6.5")

...
//class RTPForwarder: ChannelInboundHandler {
//    typealias InboundIn = AddressedEnvelope<ByteBuffer>
//    let socketAddress: SocketAddress
//    let notifier: (RTPPacket, Date) -> Void
//    
//    init(destination: String, port: Int, notifier: @escaping (RTPPacket, Date) -> Void) throws {
//        socketAddress = try SocketAddress(ipAddress: destination, port: port)
...
//        
//        if let packet = RTPPacket(buffer: byteBuffer) {
//            notifier(packet, Date.now)
//        }
//        
//        // Forward RTP packet to destination
//        let forwardEnvelope = AddressedEnvelope(remoteAddress: socketAddress, data: byteBuffer)
//        context.writeAndFlush(self.wrapOutboundOut(forwardEnvelope), promise: nil)
//    }
//}
//
//struct RTPTimestamp {
...
//    
//    init(date: Date) {
//        let timeSince1900 = date.timeIntervalSince(Date(timeIntervalSinceReferenceDate: -2208988800))
//        let timeAsUInt64 = UInt64(timeSince1900 * 65_536)
//        let middle32Bits = UInt32((timeAsUInt64 & 0xFFFFFFFF0000) >> 16)
//        self.seconds = Double(middle32Bits) / 65_536.0
//    }
//    
//    init?(data: Data) {
//        guard data.count == 4 else { return nil }
//        let middle32Bits = UInt32(bigEndian: data.withUnsafeBytes { $0.load(as: UInt32.self) })
//        self.seconds = Double(middle32Bits) / 65_536.0
//    }
//    
//    func toData() -> Data {
//        let middle32Bits = UInt32(self.seconds * 65_536.0)
//        var bigEndianValue = middle32Bits.bigEndian
//        return Data(bytes: &bigEndianValue, count: MemoryLayout<UInt32>.size)
//    }
//    
//    static func now() -> RTPTimestamp {
//        RTPTimestamp(date: Date.now)
//    }
//    
//    func timeSince(other: RTPTimestamp) -> RTPTimeInterval {
//        RTPTimeInterval(seconds: self.seconds - other.seconds)
//    }
//}
//
//struct RTPTimeInterval {
//    let seconds: Double
//    
...
//    
//    init?(data: Data) {
//        guard let timeIntervalBits = UInt32(rtpData: data) else {
//            return nil
//        }
//        self.seconds = Double(timeIntervalBits) / 65_536.0
//    }
//    
//    func toData() -> Data {
//        return UInt32(seconds * 65_536.0).toData()
//    }
//}
//
//struct RTPPacket {

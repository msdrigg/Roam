...
enum RemoteButton: String, AppEnum {
    case up = "Up"
    case left = "Left"
    case right = "Right"
    case down = "Down"
    ...
    static var typeDisplayName: LocalizedStringResource = "Button"

    static var typeDisplayRepresentation = TypeDisplayRepresentation(
        stringLiteral: "Button"
    )

    static var caseDisplayRepresentations: [RemoteButton: DisplayRepresentation] = [
        .up: "Up",
        .left: "Left",
        .right: "Right",
        .down: "Down",
    ...
    static var buttonApiDescription: [RemoteButton: String] = [
        .up: "Up",
        .left: "Left",
        .right: "Right",
        .down: "Down",
